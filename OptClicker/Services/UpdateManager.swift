...
class UpdateManager {
    ...
    let latestReleaseAPI = "https://api.github.com/repos/gitmichaelqiu/OptClicker/releases/latest"
    let latestReleaseURL = "https://github.com/gitmichaelqiu/OptClicker/releases/latest"
